...
namespace UnityEngine.XR.OpenXR.Features.Interactions
{
    ...
    public class HTCViveTrackerProfile : OpenXRInteractionFeature
    {
        ...
        /// </summary>
        [Preserve, InputControlLayout(displayName = "HTC Vive Tracker (OpenXR)", commonUsages = new[] { "Left Foot", "Right Foot", "Left Shoulder", "Right Shoulder", "Left Elbow", "Right Elbow", "Left Knee", "Right Knee", "Waist", "Chest", "Camera", "Keyboard" ,"Left Wrist", "Right Wrist"})]
        public class XRViveTracker : XRTracker
        {
            ...
            protected override void FinishSetup()
            {
                ...
                else if ((deviceDescriptor.characteristics & (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerLeftWrist) != 0)
                    InputSystem.InputSystem.SetDeviceUsage(this, "Left Wrist");
                else if ((deviceDescriptor.characteristics & (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerRightWrist) != 0)
        ...
        //"Left Foot", "Right Foot", "Left Shoulder", "Right Shoulder", "Left Elbow", "Right Elbow", "Left Knee", "Right Knee", "Waist", "Chest", "Camera", "Keyboard","Left Wrist", "Right wrist"
        [Flags]
        public enum InputDeviceTrackerCharacteristics : uint
        {
            ...
            TrackerLeftWrist = 0x1000000u,
            TrackerRightWrist = 0x2000000u
        }
        ...
        protected override void RegisterActionMapsWithRuntime()
        {
            ActionMapConfig actionMap = new ActionMapConfig()
            {
                ...
                deviceInfos = new List<DeviceConfig>()
                {
                    ...
                    new DeviceConfig()
                    {
                        characteristics = (InputDeviceCharacteristics.TrackedDevice) | (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerLeftWrist,
                        userPath = TrackerUserPaths.leftWrist
                    },
                    new DeviceConfig()
                    {
                        characteristics = (InputDeviceCharacteristics.TrackedDevice) | (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerRightWrist,
                        userPath = TrackerUserPaths.rightWrist
                    }
                },
